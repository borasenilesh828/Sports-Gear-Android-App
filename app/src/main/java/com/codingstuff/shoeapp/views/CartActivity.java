...
import com.codingstuff.shoeapp.PaymentActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkoutBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("totalPrice", totalCartPriceTv.getText().toString());
                intent.putExtra("productName", "YourProduct"); // Replace with actual product data
                intent.putExtra("productPrice", "YourPrice"); // Replace with actual product data
